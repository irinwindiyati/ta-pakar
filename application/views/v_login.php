...
<html>
  <head>
    ...
    <!-- Main CSS-->
    <link href="<?php echo base_url('assets/Admin/docs/css/main.css')?>" rel="stylesheet" type="text/css">
    <!-- Font-icon css-->
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <img src="<?php echo base_url('assets/Admin/img/logo.png') ?>" style="width: 155px; height: 155px; margin-left: 15px;">
      </div>
      <div class="login-box">
        <form class="login-form" action="<?php echo base_url('Login/aksi_login');?>" method="post">
          ...
          <div class="form-group">
            <div class="utility">
               <p class="semibold-text mb-2"><a href="Login/forgot_password">Lupa Password ?</a></p>
            </div>
          </div>
